...
ablation_settings = {
    # One group: four coordinate features
    "remove_coords": {
        "remove_cont": ["DEP_LON", "DEP_LAT", "DEST_LON", "DEST_LAT"],
        "remove_disc": [],
        "description": "remove DEP_LON, DEP_LAT, DEST_LON, DEST_LAT",
    },
    "remove_DRIVE_MILE": {
        "remove_cont": ["DRIVE_MILE"],
        "remove_disc": [],
        "description": "remove DRIVE_MILE",
    },
    "remove_PRICE": {
        "remove_cont": ["PRICE"],
        "remove_disc": [],
    ...
    "remove_DRIVE_TIME": {
        "remove_cont": ["DRIVE_TIME"],
        "remove_disc": [],
        "description": "remove DRIVE_TIME",
    },
    "remove_isPeakTime": {
        "remove_cont": [],
        "remove_disc": ["isPeakTime"],
        "description": "remove isPeakTime",
    },
    "remove_isWeekend": {
        "remove_cont": [],
        "remove_disc": ["isWeekend"],
        "description": "remove isWeekend",
    },
    "remove_isTime": {
        "remove_cont": [],
        "remove_disc": ["isTime"],
        "description": "remove isTime",
    },
    "remove_isLong": {
        "remove_cont": [],
        "remove_disc": ["isLong"],
        "description": "remove isLong",
    },
    "remove_operateSpeed": {
        "remove_cont": ["operateSpeed"],
        "remove_disc": [],
        "description": "remove operateSpeed",
    },
    "remove_Manhattan": {
        "remove_cont": ["Manhattan"],
        "remove_disc": [],
        "description": "remove Manhattan",
    },
    "None": {
        "remove_cont": [],
        "remove_disc": [],
